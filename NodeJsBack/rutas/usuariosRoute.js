...
usuariosRoute.put('/:id', [mdAutenticacion.verificarToken, mdAutenticacion.verificarRole], (req, res) => {
...
usuariosRoute.delete('/:id', [mdAutenticacion.verificarToken, mdAutenticacion.verificarRole], (req, res) => {
